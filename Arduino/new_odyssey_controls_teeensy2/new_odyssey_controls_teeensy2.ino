...
const int cardAdvancePin = PIN_B0;
const int cardBackPin = PIN_B1;
const int menuPin = PIN_C7;
const int menuTogglePin = PIN_D6;
const int menuSelectPin = PIN_D7;
const int accessoryHitPin = PIN_B2;
const int accessoryResetPin = PIN_B3;
...
int newLeftEnglishVal = analogRead(PIN_F4); //Left English Pot Value
...
int newRightHorizontalVal = analogRead(PIN_F6); //Right Horizontal pot Value
...
int newRightVerticalVal = analogRead(PIN_F5); //Right Vertical Pot Value
...
int newRightEnglishVal = analogRead(PIN_F7); //Right English Pot Value
...
int newAux1Val = analogRead(PIN_B4); //Aux Values, Pots 1-8, changed from A to F
if(newAux1Val - aux1Val>=3||newAux1Val - aux1Val<=-3){
  //Serial.println(newAux1Val);
  aux1Val = newAux1Val;
   
}
int newAux2Val = analogRead(PIN_B5); //Same
